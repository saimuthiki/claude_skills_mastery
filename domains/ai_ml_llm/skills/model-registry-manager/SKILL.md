---
name: managing-model-registry
description: |
  Model Registry Manager - Auto-activating skill for ML Deployment.
...
- "Help me with model registry manager"
- "Set up model registry manager"
- "How do I implement model registry manager?"
