---
name: generating-sql-migrations
description: |
  Sql Migration Generator - Auto-activating skill for Backend Development.
...
- Provides step-by-step guidance for sql migration generator
