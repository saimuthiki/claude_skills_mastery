---
name: setting-up-memory-profiler
description: |
...
- Provides step-by-step guidance for memory profiler setup
...
- "Help me with memory profiler setup"
- "Set up memory profiler setup"
- "How do I implement memory profiler setup?"
