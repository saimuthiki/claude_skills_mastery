...
- Provides step-by-step guidance for sns topic config
...
- "Help me with sns topic config"
- "Set up sns topic config"
- "How do I implement sns topic config?"
