---
name: checking-input-validation
description: |
...
- Provides step-by-step guidance for input validation checker
...
- "Help me with input validation checker"
- "Set up input validation checker"
- "How do I implement input validation checker?"
