...
- Provides step-by-step guidance for key rotation manager
...
- "Help me with key rotation manager"
- "Set up key rotation manager"
- "How do I implement key rotation manager?"
